...
<div class="row">
	...
	<div class="row">
		...
		<div class="eight columns">
			...
			<div style="padding-bottom: 10px;"><a href='<s:url value="/user/registration/${registration.uuid }/stepback/2" />' class="radius button small">Change Billing Address</a></div>
		</div>
		<div class="four columns">
			<b>Payment Details:</b>
		</div>
		<div class="eight columns">
			<div style="padding-bottom: 10px;"><b>Cardholder Name:</b> <br />${registration.name}</div>
			<div style="padding-bottom: 10px;"><b>Card Number Ending:</b> <br />${registration.secureCardNo}</div>
			<div style="padding-bottom: 10px;"><b>Expiry Date:</b> <br />${registration.month + 1}/${registration.year}</div>
			<div style="padding-bottom: 10px;"><a href='<s:url value="/user/registration/${registration.uuid }/stepback/1" />' class="radius button small">Change Payment Details</a></div>
		</div>
